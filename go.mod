module github.com/jumpcrypto/mirasol
...
require (
	...
	// TODO adopt a release when a newer than 1.8.2 is cut.
	github.com/gagliardetto/solana-go v1.8.3-0.20230106160614-939f8e126ad3
